...
//Когда мы вставляем массив в innerHTML он преобразуется в строку по методу join. По умолчанию, в этом методе
//вставляется разделитель - запятая. Можно самостоятельно установить разделитель - любой символ, пробел,
